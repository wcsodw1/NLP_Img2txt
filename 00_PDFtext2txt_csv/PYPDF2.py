...
# python PYPDF2.py -f '../data/testing/input/20221129CV.pdf' -o '../data/testing/output/PDFtext2txt_20221129CV.txt'
# python PYPDF2.py -f '../data/Wizpresso/input/file.pdf' -o '../data/Wizpresso/output/PDFtext2txt_file.txt'
