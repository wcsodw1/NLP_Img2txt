...
# python PYPDF2_PDF2txt.py -f './data/Wizpresso/input/20221129CV.pdf' -o './data/Wizpresso/output/PyPDF2_20221129CV.txt'
# python PYPDF2_PDF2txt.py -f './data/Wizpresso/input/file.pdf' -o './data/Wizpresso/output/PyPDF2_file.txt'
